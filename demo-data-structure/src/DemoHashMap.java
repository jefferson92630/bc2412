...
public class DemoHashMap {
  ...
  public static class Book {
    ...
    public boolean equals(Object obj) {
      ...
      Objects.equals(this.id, book.getId());
    }
  ...
  public static void main(String[] args) {
    ...
    // Find the entry of "Apple", and then + 1 to the integer.
      if (fruitMap.containsKey("Apple")) {
        ...
        System.out.println(fruitMap); // {Apple=4, APPLE=3}
      } 

      Integer value = fruitMap.get("Apple");
      if (value != null) {
        fruitMap.put("Apple", value + 1); // {Apple=5}
      }
      ...
      fruitMap.put(null, 1000); // {null=1000, Apple=5, ABC=null, APPLE=3}
